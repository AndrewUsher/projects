...
},{"fbjs/lib/invariant":21,"fbjs/lib/warning":18,"./lib/ReactPropTypesSecret":23}],10:[function(require,module,exports) {
/** @license React v16.2.0
...
},{"object-assign":16,"fbjs/lib/emptyObject":19,"fbjs/lib/invariant":21,"fbjs/lib/warning":18,"fbjs/lib/emptyFunction":20,"prop-types/checkPropTypes":17}],5:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.production.min.js":9,"./cjs/react.development.js":10}],24:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./isNode":41}],28:[function(require,module,exports) {
'use strict';
...
},{"./isTextNode":39}],29:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"react":5,"fbjs/lib/ExecutionEnvironment":24,"object-assign":16,"fbjs/lib/emptyFunction":20,"fbjs/lib/EventListener":26,"fbjs/lib/getActiveElement":27,"fbjs/lib/shallowEqual":31,"fbjs/lib/containsNode":28,"fbjs/lib/focusNode":29,"fbjs/lib/emptyObject":19}],33:[function(require,module,exports) {
'use strict';
...
},{"react":5,"fbjs/lib/invariant":21,"fbjs/lib/warning":18,"fbjs/lib/ExecutionEnvironment":24,"object-assign":16,"fbjs/lib/emptyFunction":20,"fbjs/lib/EventListener":26,"fbjs/lib/getActiveElement":27,"fbjs/lib/shallowEqual":31,"fbjs/lib/containsNode":28,"fbjs/lib/focusNode":29,"fbjs/lib/emptyObject":19,"prop-types/checkPropTypes":17,"fbjs/lib/hyphenateStyleName":30,"fbjs/lib/camelizeStyleName":25}],6:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.production.min.js":11,"./cjs/react-dom.development.js":12}],40:[function(require,module,exports) {
/*!
...
},{"isobject":40}],35:[function(require,module,exports) {
/*
 *          __        ___
 *    _____/ /___  __/ (_)____
 *   / ___/ __/ / / / / / ___/
...
},{"fbjs/lib/emptyFunction":20,"fbjs/lib/invariant":21,"fbjs/lib/warning":18,"object-assign":16,"./lib/ReactPropTypesSecret":23,"./checkPropTypes":17}],43:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/emptyFunction":20,"fbjs/lib/invariant":21,"./lib/ReactPropTypesSecret":23}],37:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./factoryWithTypeCheckers":42,"./factoryWithThrowingShims":43}],36:[function(require,module,exports) {
/**
...
},{"is-plain-object":38,"stylis":35,"stylis-rule-sheet":34,"react":5,"prop-types":37,"hoist-non-react-statics":36}],7:[function(require,module,exports) {
'use strict';
...
},{"react":5,"styled-components":13}],14:[function(require,module,exports) {
'use strict';
...
module.exports="/dist/350b7a7a62a15a6e28a1a664009acb98.png";
...
var _landingPage = require('../img/landing-page.png');
...
var ProjectTitle = _styledComponents2.default.span(_templateObject3);

var ProjectCategory = _styledComponents2.default.span(_templateObject4);

var ProjectImage = _styledComponents2.default.img(_templateObject5);

var ProjectItem = function ProjectItem(props) {
  return _react2.default.createElement(
    A,
    { href: props.project.liveSite, target: '_blank' },
    _react2.default.createElement(
      Item,
      null,
      _react2.default.createElement(ProjectImage, { src: _landingPage2.default }),
      _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(
...
},{"react":5,"styled-components":13,"../img/landing-page.png":22}],8:[function(require,module,exports) {
'use strict';
...
var categories = ['All', 'API', 'Boilerplate', 'CSS', 'Experiment', 'Game', 'Landing Page', 'Redesign'];
var Container = _styledComponents2.default.div(_templateObject);

var ProjectsContainer = _styledComponents2.default.div(_templateObject2);

var Input = _styledComponents2.default.input(_templateObject3);

var FilterContainer = _styledComponents2.default.div(_templateObject4);

var FilterTitle = _styledComponents2.default.h2(_templateObject5);

var CategoryInput = _styledComponents2.default.input(_templateObject);

var CategoryLabel = _styledComponents2.default.label(_templateObject6);

var RadioContainer = _styledComponents2.default.div(_templateObject7);
...
var Projects = function (_Component) {
    ...
    _createClass(Projects, [{
        ...
        value: function filterByCategory(event) {
            this.setState({
        ...
        value: function render() {
            ...
            var filteredList = this.state.projects.filter(function (project) {
                return project.title.toLowerCase().indexOf(_this2.state.searchTerm.toLowerCase()) !== -1;
            }).filter(function (project) {
                if (_this2.state.categoryFilter === '' || _this2.state.categoryFilter === 'all') {
                    return true;
                } else {
                    return project.radioCategory === _this2.state.categoryFilter;
                }
            });
            return _react2.default.createElement(
                Container,
                    ...
                    _react2.default.createElement(
                        ...
                        categories.map(function (category, index) {
                            return _react2.default.createElement(
                                RadioContainer,
                                { key: index },
                                _react2.default.createElement(CategoryInput, {
                                    value: category,
                                    onChange: _this2.filterByCategory.bind(_this2),
                                    type: 'radio',
                ...
                _react2.default.createElement(
                    ...
                    filteredList.map(function (project) {
                        return _react2.default.createElement(_ProjectItem2.default, { key: project.id, project: project });
                    })
                )
            );
        }
...
exports.default = Projects;
},{"react":5,"styled-components":13,"./projectList":14,"./ProjectItem":15}],4:[function(require,module,exports) {
'use strict';
...
exports.default = App;
},{"react":5,"./components/Navbar":7,"./components/Projects":8}],2:[function(require,module,exports) {
'use strict';
...
},{"react":5,"react-dom":6,"./App":4}],69:[function(require,module,exports) {
...
//# sourceMappingURL=/dist/b91b5a9688caadd88af640c59ee619db.map